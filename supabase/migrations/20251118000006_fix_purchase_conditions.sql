-- Migration: Fix purchase conditions for locked techniques
-- Date: 2025-11-18
-- Description: Исправление логики покупки - условия разблокировки должны проверяться ДО разрешения покупки
...
BEGIN
  ...
  -- === ПРОВЕРКА УСЛОВИЙ РАЗБЛОКИРОВКИ (для locked техник) ===
...
COMMENT ON FUNCTION can_user_purchase_technique IS 'Проверяет выполнены ли условия для покупки техники. Условия разблокировки проверяются для всех пользователей.';

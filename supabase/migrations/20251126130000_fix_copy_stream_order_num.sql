-- Migration: Fix order_num uniqueness in copy_stream_with_config
-- Date: 2025-11-26
-- Description: Исправляем уникальность order_num при копировании ступеней
...
'Полное копирование потока с конфигурацией. Копирует модули, ступени, уроки, блоки, события, тарифы и материалы.';
...
BEGIN
  ...
  RAISE NOTICE '  - Исправлена уникальность order_num для ступеней';
  RAISE NOTICE '  - Добавлен суффикс к именам ступеней';
  RAISE NOTICE '  - Копирует все данные потока';
END $$;

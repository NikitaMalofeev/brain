-- Migration: Fix get_tariff_configuration to return tariff_module_technique_id
-- Date: 2025-11-25
-- Description: Добавление tariff_module_technique_id в возвращаемые данные функции
...
BEGIN
  ...
  SELECT
    ...
    tmt.id as tariff_module_technique_id,

-- Migration: Add cover_image to get_stream_module_details
-- Date: 2025-12-05
-- Description: Добавляем module_cover_image в функцию get_stream_module_details

DROP FUNCTION IF EXISTS public.get_stream_module_details(UUID, UUID);
...
COMMENT ON FUNCTION public.get_stream_module_details IS 'Получить детали модуля потока с уроками, обложкой и прогрессом пользователя';

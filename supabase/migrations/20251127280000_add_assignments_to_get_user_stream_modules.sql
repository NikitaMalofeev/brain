-- Migration: Add assignment counts to get_user_stream_modules
-- Date: 2025-11-27
-- Description: Добавить подсчёт заданий (total_assignments, completed_assignments) для корректного отображения прогресса
...
BEGIN
    ...
    -- НОВОЕ: Статистика по заданиям модуля
...
- total_assignments и completed_assignments для отображения прогресса по заданиям';
...
BEGIN
    ...
    RAISE NOTICE '  - Добавлено поле total_assignments - общее количество заданий';
    RAISE NOTICE '  - Добавлено поле completed_assignments - выполненные задания (approved)';
END $$;

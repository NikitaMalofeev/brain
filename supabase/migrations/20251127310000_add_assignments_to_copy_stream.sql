-- Migration: Add assignments copy to copy_stream_with_config
-- Date: 2025-11-27
-- Description: Добавить копирование заданий (assignments) при копировании потока
...
BEGIN
  ...
  -- 6. НОВОЕ: Копируем задания (assignments)
...
BEGIN
  ...
  RAISE NOTICE '  - Добавлено копирование assignments (заданий)';
END $$;

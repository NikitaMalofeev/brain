...
- **Подзадачи:**
    ...
    - [x] **Реализация:** Внедрить UI и логику в админ-панель.
        ...
        - [x] **Шаг 4: Форма добавления/удаления баллов** - UI для корректировки баллов студентов
            - [x] Добавить поле ввода `deltaPoints` и кнопки "Добавить баллы"/"Удалить баллы"
            - [x] Реализовать валидацию ввода (только положительные числа)
            - [x] Добавить состояние загрузки `pointsLoading` для блокировки UI
            - [x] Использовать существующую функцию `updateStudentPoints` вместо создания новых
            - [x] Добавить информативные уведомления об успехе операций

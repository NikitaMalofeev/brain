...
- **Функционал:**
    - **Создание:** Модальное окно с полями для нового чата (название, описание, ссылка, порядковый номер).
    - **Редактирование:** То же модальное окно для изменения существующего чата.
...
## 9. Настройки и права (/admin/settings)

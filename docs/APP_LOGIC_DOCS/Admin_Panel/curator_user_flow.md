...
Все остальные разделы, доступные администратору (управление курсами, материалами, тарифами и т.д.), для куратора **скрыты**, чтобы не перегружать интерфейс и ограничить доступ только необходимыми функциями.

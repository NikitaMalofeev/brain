...
type AdminTab = 'students' | 'curators' | 'courses' | 'submissions' | 'materials' | 'tariffs' | 'chats' | 'faq' | 'broadcasts' | 'tokens' | 'techniques' | 'streams' | 'modules' | 'calendar';
    ...
    <PlayerProvider>
      <div className="admin-page">
        ...
        <div className="admin-tabs">
          ...
          {adminUser?.role === 'admin' && (
            <>
              ...
              <button
                className={`admin-tab ${currentTab === 'modules' ? 'active' : ''}`}
        ...
        <div className="admin-main-content">
          ...
          {currentTab === 'courses' && <UnifiedCoursesManager />}
          ...
          {currentTab === 'modules' && <ModulesManager />}

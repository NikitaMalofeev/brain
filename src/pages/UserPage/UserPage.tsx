                ...
                >
                    ...
                    <motion.div variants={itemVariants} className={' grid grid-cols-2 gap-3 mb-3 px-4'}>
                        ...
                        <div className={'p-3 rounded-2xl bg-white flex items-center flex-col'}>
                            ...
                            <p className={'text-[20px] font-bold'}>{isGuest ? '—' : `${completedAssignments} из ${totalAssignments}`}</p>
                        ...
                        <div className={'p-3 rounded-2xl bg-white flex items-center flex-col'}>
                            ...
                            <p className={'text-[20px] font-bold'}>{isGuest ? '—' : `${overdueAssignments} из ${totalAssignments}`}</p>
                            <p className={'text-sm font-bold'}>заданий</p>
                        </div>
                        <div
